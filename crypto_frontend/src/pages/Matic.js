                                                    ...
                                                    <div className={`card card-flush h-xl-100 ${highlightedDiv === 1 ? 'highlighted' : ''}`}  style={{backgroundColor: '#dba5d3'}}>
                                                        ...
                                                        <div className="card-header flex-nowrap pt-5">
                                                            ...
                                                            <h3 className="card-title align-items-start flex-column">
                                                                <span className="card-label fw-bold fs-4 text-gray-800">Matic Price</span>
                                                                <span className="mt-1 fw-semibold fs-7"  >989,035 USD for 1 Matic</span>
                                                            </h3>
                                                        ...
                                                        <div className="card-body text-center pt-5">
                                                            ...
                                                            <img src="assets/media/svg/shapes/matic.png" className="h-125px mb-5" alt="" />

                                                            <div className="text-start">
                                                                <span className="d-block fw-bold fs-1 text-gray-800">29.33460000 </span>
                                                                <span className="mt-1 fw-semibold fs-3"  >4,598,00 USD</span>
                                                            </div>
                                                    ...
                                                    <div className={`card card-flush h-xl-100 ${highlightedDiv === 2 ? 'highlighted' : ''}`} style={{backgroundColor: '#83c975'}}>
                                                        ...
                                                        <div className="card-header flex-nowrap pt-5">
                                                            ...
                                                            <h3 className="card-title align-items-start flex-column">
                                                                ...
                                                                <span className="mt-1 fw-semibold fs-7"  >0.95,049 USD for 1 Matic</span>
                                                            </h3>
                                                        ...
                                                        <div className="card-body text-center pt-5">
                                                            ...
                                                            <div className="text-start">
                                                                ...
                                                                <span className="mt-1 fw-semibold fs-3"  >222,005,56 USD</span>
                                                            </div>
                                                    ...
                                                    <div className="card card-flush h-xl-100" style={{ backgroundColor: '#ffe6be' }}>
                                                        ...
                                                        <div className="card-header flex-nowrap pt-5">
                                                            ...
                                                            <h3 className="card-title align-items-start flex-column">
                                                                ...
                                                                <span className="mt-1 fw-semibold fs-7"  >11,668 USD for 1 Matic</span>
                                                            </h3>
                                                        ...
                                                        <div className="card-body text-center pt-5">
                                                            ...
                                                            <div className="text-start">
                                                                ...
                                                                <span className="mt-1 fw-semibold fs-3"  >99,111,45 USD</span>
                                                            </div>
                                                    ...
                                                    <div className="card card-flush h-xl-100" style={{backgroundColor: '#80ccd9'}}>
                                                        ...
                                                        <div className="card-header flex-nowrap pt-5">
                                                            ...
                                                            <h3 className="card-title align-items-start flex-column">
                                                                ...
                                                                <span className="mt-1 fw-semibold fs-7"  >9.12,045 USD for 1 Matic</span>
                                                            </h3>
                                                        ...
                                                        <div className="card-body text-center pt-5">
                                                            ...
                                                            <div className="text-start">
                                                                <span className="d-block fw-bold fs-1 text-gray-800">4703.7589 </span>
                                                                <span className="mt-1 fw-semibold fs-3"  >666,005,56 USD</span>
                                                            </div>
                                    ...
                                    <div className="col-md-12">
                                        <div className="mb-5 text-left">
                                            ...
                                            <div className="fw-semibold fs-5 text-gray-600 text-gray-900 mt-4">    
                                                 What is Matic?<br/>
                                                 Matic is a Proof-of-Stake blockchain that powers decentralized applications (dApps) through smart contracts, without being controlled by a centralized entity. As the first blockchain to feature smart contracts, it has the largest ecosystem of decentralized applications, ranging from decentralized exchanges to crypto lending and borrowing platforms and more.<br/> 
